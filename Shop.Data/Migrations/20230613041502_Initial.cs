        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrangThai = table.Column<int>(type: "int", nullable: false),
                    AnhBanDau = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SdtNguoiShip = table.Column<string>(type: "varchar(25)", nullable: true),
                    TenNguoiShip = table.Column<string>(type: "nvarchar(256)", nullable: true),
                    PhanTramGiamGia = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    SoDiemSuDung = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    SoTienQuyDoi = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    TienShip = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1fa242d3-99c5-4d96-84a7-2a0c42c5f01a"), "hang2", 500, "Đồng", 1 },
                    { new Guid("746cb698-abdc-42a4-8f0c-f6aea599dfba"), "hang6", 10000, "Kim Cương", 1 },
                    { new Guid("76a8265a-1c5a-4b8c-9a53-c5b2937b9731"), "hang1", 0, "Thân Thiện", 1 },
                    { new Guid("8384a802-700c-4040-b80d-744a028a74e0"), "hang4", 2000, "Vàng", 1 },
                    { new Guid("894e4300-be80-489c-ad4b-c81cca3ef451"), "hang5", 5000, "Bạch Kim", 1 },
                    { new Guid("fb0496fb-aef3-4693-9cf7-8f66ae988a9b"), "hang3", 1000, "Bạc", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("3698ae73-eaf4-414e-890c-32d7e8073a1c"), "cv2", "Nhân Viên Bán Hàng", 1 },
                    { new Guid("e0abfb76-d44c-42e0-8a7a-542e55b874c0"), "cv1", "Quan Ly", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a1ef45d3-64a2-41db-8e2f-92f94be68901"), "dm1", "Real", 1 },
                    { new Guid("d2a7e269-21e1-4dec-969a-b034ddc2ce56"), "dm2", "Rep 1:1", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("408db8d3-3690-454c-bef4-bdfe2e6c117a"), "Mười", 1, "gg1", 10, 100000m, new DateTime(2023, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Xả hàng", 1 },
                    { new Guid("a0078543-2638-481e-9609-17960504eb63"), "Hai", 2, "gg2", 40, 200000m, new DateTime(2023, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), "Hàng Tồn Kho", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1f9ef290-cba3-4fd5-a5d8-453c1ab422a2"), "kc1", 40, 1 },
                    { new Guid("f342f0a1-7e87-4917-979c-02d5ba80be80"), "kc2", 42, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2e97d6b9-2f4a-4b41-accf-18f86223621d"), "ms2", "Đen", 1 },
                    { new Guid("a427ff0d-44ac-4194-9c72-ca86f0d84b4e"), "ms1", "Trắng", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("5033bc0f-afe2-4f74-b15b-f1fcc36d2aa3"), "sp2", "Cotton On Ruby ", 1 },
                    { new Guid("9cfe9060-0102-427e-a78f-1d8706ff1ded"), "sp1", "Giày Converse", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("90c348df-4cfa-428e-873b-8a700340c99a"), "v1", "Mua một triệu giảm 100000", new DateTime(2023, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 6, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 100, 1000000m, 100000m, "Giảm giá tháng 5 và 6", 1 },
                    { new Guid("97078617-27fc-4874-afaf-1e5e8468fe95"), "v2", "Giảm 400000 khi mua hàng đạt 2000000vnd", new DateTime(2023, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 5, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), 50, 2000000m, 400000m, "Giảm giá tháng 5", 1 }
                });

            migrationBuilder.InsertData(
                table: "CTSanPhams",
                columns: new[] { "Id", "AnhBanDau", "GiaBan", "GiaNhap", "IdDanhMuc", "IdGiamGia", "IdKichCo", "IdMauSac", "IdSanPham", "Ma", "MoTa", "SoLuongTon", "TrangThai" },
                values: new object[,]
                {
                    { new Guid("93351f9a-eb83-4bc2-969d-a46275a16c7a"), "/AnhSanPham/2.webp", 799000m, 700000m, new Guid("d2a7e269-21e1-4dec-969a-b034ddc2ce56"), new Guid("a0078543-2638-481e-9609-17960504eb63"), new Guid("f342f0a1-7e87-4917-979c-02d5ba80be80"), new Guid("2e97d6b9-2f4a-4b41-accf-18f86223621d"), new Guid("5033bc0f-afe2-4f74-b15b-f1fcc36d2aa3"), "ctsp2", "Sneakers with a sharp-looking minimalist design. Designed with fine details for superb comfort.", 90, 1 },
                    { new Guid("ed52daa9-f264-44af-af2e-fcf01955f968"), "/AnhSanPham/1.webp", 1500000m, 1000000m, new Guid("a1ef45d3-64a2-41db-8e2f-92f94be68901"), new Guid("408db8d3-3690-454c-bef4-bdfe2e6c117a"), new Guid("1f9ef290-cba3-4fd5-a5d8-453c1ab422a2"), new Guid("a427ff0d-44ac-4194-9c72-ca86f0d84b4e"), new Guid("9cfe9060-0102-427e-a78f-1d8706ff1ded"), "ctsp1", "Sneakers with a sharp-looking minimalist design. Designed with fine details for superb comfort.", 100, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("9bc9a001-7fa3-4a16-a4ee-34df4fcc53c5"), "Cầu Giấy, Hà Nội", "hq37na@gmail.com", "Khách hàng thân thiện", 1, "Nguyễn Kim Học", new Guid("76a8265a-1c5a-4b8c-9a53-c5b2937b9731"), "kh1", "hoc123456", new DateTime(2003, 7, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), 0, "0395297378", "hocnk123", 1 },
                    { new Guid("c63a7259-0d4d-4d80-80db-774922c47951"), "Sóc Sơn, Hà Nội", "cuongnpm@gmail.com", "Khách hàng Bạch Kim", 1, "Nguyễn Phúc Minh Cương", new Guid("894e4300-be80-489c-ad4b-c81cca3ef451"), "kh2", "cuong123456", new DateTime(2003, 6, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), 5000, "0972756511", "cuongnpm123", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("27ce22ac-ff4e-4442-83e0-6289ef849328"), "/image/4.png", new Guid("ed52daa9-f264-44af-af2e-fcf01955f968"), "anh4", 1 },
                    { new Guid("2f355c69-3c5a-42e5-895a-e5093bf41e79"), "/image/3.png", new Guid("ed52daa9-f264-44af-af2e-fcf01955f968"), "anh3", 1 },
                    { new Guid("34c178f4-fa6b-4f5c-bd34-784393a8437a"), "/image/1.png", new Guid("ed52daa9-f264-44af-af2e-fcf01955f968"), "anh1", 1 },
                    { new Guid("d6c09720-859c-4a45-9123-d2a9853dd720"), "/image/5.png", new Guid("ed52daa9-f264-44af-af2e-fcf01955f968"), "anh5", 1 },
                    { new Guid("dbfa5886-01ab-401f-b671-9a5d1e070e28"), "/image/2.png", new Guid("ed52daa9-f264-44af-af2e-fcf01955f968"), "anh2", 1 }
                });
