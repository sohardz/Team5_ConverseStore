...
namespace Shop.Data.Migrations
{
    ...
    [Migration("20230516064652_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Data.Models.LichSuTieuDiem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("IdQuyDoi")
                        .HasColumnType("int");

                    b.Property<int>("IdViDiem")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shop.Data.Models.QuyDoiDiem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("TienTichDiem")
                        .HasColumnType("decimal");

                    b.Property<decimal>("TienTieuDiem")
                        .HasColumnType("decimal");
            ...
            modelBuilder.Entity("Shop.Data.Models.SanPhamGiamGia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shop.Data.Models.ViDiem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shop.Data.Models.VoucherKhachHang", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VoucherKhachHangs");
                });

            modelBuilder.Entity("Shop.Data.Models.VoucherLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("TienTruocGiamGia")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Shop.Data.Models.CTHoaDon", b =>
                {
                    b.HasOne("Shop.Data.Models.HoaDon", null)
                        .WithMany("CTHoaDons")
            ...
            modelBuilder.Entity("Shop.Data.Models.KhachHang", b =>
                {
                    b.HasOne("Shop.Data.Models.ViDiem", "ViDiem")
                        .WithOne("KhachHang")
                        .HasForeignKey("Shop.Data.Models.KhachHang", "IdDiem")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Shop.Data.Models.LichSuTieuDiem", b =>
                {
                    ...
                    b.HasOne("Shop.Data.Models.QuyDoiDiem", "QuyDoiDiem")
                        .WithMany("LichSuTieuDiems")
